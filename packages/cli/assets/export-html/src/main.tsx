...
const logoSvgWithGradient = (() => {
  ...
  const gradientDef =
    '<defs><linearGradient id="ollama-logo-gradient" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#60a5fa" /><stop offset="100%" stop-color="#a855f7" /></linearGradient></defs>';
    ...
    <div className="page-wrapper">
      <header className="header">
        <div className="header-left">
          ...
          />
          <div className="logo">
            <div className="logo-text" data-text="OLLAMA">
              <span className="logo-text-inner">OLLAMA</span>
            </div>
          </div>
        </div>
        <div className="meta">
