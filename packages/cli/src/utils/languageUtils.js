 ...
 * This file handles the creation and maintenance of ~/.ollama-code/output-language.md
...
function getOutputLanguageFilePath() {
    return path.join(Storage.getGlobalOllamaDir(), LLM_OUTPUT_LANGUAGE_RULE_FILENAME);
}
/**
