 ...
 */
import { OutputFormat, ToolErrorType, createDebugLogger, getMCPServerStatus, } from '@ollama-code/ollama-code-core';
 ...
 */
export function extractUsageFromOllamaClient(geminiClient) {
    if (!geminiClient ||
