...
// File for 'ollama-code mcp add' command
import type { CommandModule } from 'yargs';
import { loadSettings, SettingScope } from '../../config/settings.js';
import { writeStdoutLine, writeStderrLine } from '../../utils/stdioHelpers.js';
import type { MCPServerConfig } from '@ollama-code/ollama-code-core';
...
export const addCommand: CommandModule = {
  ...
  builder: (yargs) =>
    yargs
      .usage('Usage: ollama-code mcp add [options] <name> <commandOrUrl> [args...]')
      .parserConfiguration({
