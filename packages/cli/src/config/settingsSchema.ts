  ...
  general: {
    ...
    properties: {
      ...
      gitCoAuthor: {
        ...
        default: true,
        description:
          'Automatically add a Co-authored-by trailer to git commit messages when commits are made through Ollama Code.',
        showInDialog: true,
      },
      checkpointing: {
        type: 'object',
      ...
      language: {
        ...
        description:
          ...
          'in ~/.ollama/locales/ (e.g., ~/.ollama/locales/es.js).',
        showInDialog: true,
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Ollama Code status and thoughts in the terminal window title',
        showInDialog: false,
      },
      hideTips: {
        type: 'boolean',
      ...
      memorySummary: {
        ...
        properties: {
          maxSummaryLength: {
            ...
            requiresRestart: false,
            default: 2000,
            description: 'Maximum characters for the compressed summary.',
            showInDialog: true,
          },
          maxActivities: {
            type: 'number',
            ...
            requiresRestart: false,
            default: 100,
            description: 'Maximum number of activities to track.',
            showInDialog: true,
          },
          autoSummarize: {
            type: 'boolean',
            ...
            requiresRestart: false,
            default: true,
            description: 'Enable automatic summarization of activities.',
            showInDialog: true,
          },
          summarizeInterval: {
            type: 'number',
            label: 'Summarize Interval',
            category: 'Memory Summary',
            requiresRestart: false,
            default: 10,
            description:
