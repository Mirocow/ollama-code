 ...
 */
import { ApprovalMode, DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, } from '@ollama-code/ollama-code-core';
    ...
    general: {
        ...
        properties: {
            ...
            gitCoAuthor: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Automatically add a Co-authored-by trailer to git commit messages when commits are made through Ollama Code.',
                showInDialog: true,
            },
            checkpointing: {
                type: 'object',
    ...
    ui: {
        ...
        properties: {
            ...
            showStatusInTitle: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Show Ollama Code status and thoughts in the terminal window title',
                showInDialog: false,
            },
            hideTips: {
                type: 'boolean',
            ...
            generationConfig: {
                ...
                properties: {
                    ...
                    contextWindowSize: {
                        ...
                        requiresRestart: false,
                        default: undefined,
                        description: "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from Ollama Code's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
                        parentKey: 'generationConfig',
                        showInDialog: false,
                    },
                },
