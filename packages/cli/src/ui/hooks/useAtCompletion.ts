...
import type { Config, FileSearch } from '@ollama-code/ollama-code-core';
import { FileSearchFactory, escapePath } from '@ollama-code/ollama-code-core';
    ...
    const initialize = async () => {
      try {
        const searcher = FileSearchFactory.create({
          ...
          useQwenignore:
            config?.getFileFilteringOptions()?.respectOllamaCodeIgnore ?? true,
          cache: true,
