...
export const AppContainer = (props: AppContainerProps) => {
  ...
  // Update terminal title with Ollama Code status and thoughts
  useEffect(() => {
    ...
    // Note: We don't need to reset the window title on exit because Ollama Code is already doing that elsewhere
  }, [
    streamingState,
    thought,
    settings.merged.ui?.showStatusInTitle,
