...
export const ToolGroupMessage = ({ toolCalls, availableTerminalHeight, contentWidth, isFocused = true, activeShellPtyId, embeddedShellFocused, }) => {
    ...
    return (_jsx(Box, { flexDirection: "column", borderStyle: "round", 
        /*
          ...
          cause tearing.
        */
        width: contentWidth, borderDimColor: hasPending && (!isShellCommand || !isEmbeddedShellFocused), borderColor: borderColor, gap: 1, children: toolCalls.map((tool) => {
