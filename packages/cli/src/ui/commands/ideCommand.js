 ...
 */
import { IdeClient, logIdeConnection, IdeConnectionEvent, IdeConnectionType, } from '@ollama-code/ollama-code-core';
import { OLLAMA_CODE_COMPANION_EXTENSION_NAME, getIdeInstaller, IDEConnectionStatus, ideContextStore, } from '@ollama-code/ollama-code-core';
    ...
    const installCommand = {
        ...
        action: async (context) => {
            ...
            if (!installer) {
                ...
                context.ui.addItem({
                    type: 'error',
                    text: `Automatic installation is not supported for ${ideName}. Please install the '${OLLAMA_CODE_COMPANION_EXTENSION_NAME}' extension manually from the marketplace.`,
                }, Date.now());
                return;
            }
            context.ui.addItem({
