 ...
 */
import type { CompressionStatus, MCPServerConfig, ThoughtSummary, ToolCallConfirmationDetails, ToolConfirmationOutcome, ToolResultDisplay } from '@ollama-code/ollama-code-core';
...
export type HistoryItemWithoutId = HistoryItemUser | HistoryItemUserShell | HistoryItemOllama | HistoryItemOllamaContent | HistoryItemOllamaThought | HistoryItemOllamaThoughtContent | HistoryItemInfo | HistoryItemError | HistoryItemWarning | HistoryItemRetryCountdown | HistoryItemAbout | HistoryItemHelp | HistoryItemToolGroup | HistoryItemStats | HistoryItemModelStats | HistoryItemToolStats | HistoryItemQuit | HistoryItemCompression | HistoryItemSummary | HistoryItemCompression | HistoryItemExtensionsList | HistoryItemToolsList | HistoryItemSkillsList | HistoryItemMcpStatus;
