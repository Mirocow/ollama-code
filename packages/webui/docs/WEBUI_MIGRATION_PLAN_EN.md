...
1. Extract components from `vscode-ide-companion/src/webview/` into an independent `@ollama-code/webui` package
...
```typescript
// @ollama-code/webui/src/context/PlatformContext.ts
...
```javascript
// @ollama-code/webui/tailwind.preset.js
module.exports = {
  theme: {
    extend: {
      colors: {
...
module.exports = {
  presets: [require('@ollama-code/webui/tailwind.preset')],
  content: [
    './src/**/*.{ts,tsx}',
    './node_modules/@ollama-code/webui/dist/**/*.js',
  ],
};
```
...
```
Developer ──► @ollama-code/webui ──► vscode-ide-companion
  │              │                      │
...
// After: Update import
import { FileIcon } from '@ollama-code/webui';
// or import { FileIcon } from '@ollama-code/webui/icons';
```
...
1. **Tailwind Class Name Tree Shaking**
   ...
   - Solution: Consumer's `content` config needs to include `node_modules/@ollama-code/webui`
...
│     └── Edit files in @ollama-code/webui/src/                     │
│                                                                  │
...
│     └── import { Component } from '@ollama-code/webui'            │
...
1. **Single Source of Truth**: All UI components live in `@ollama-code/webui`
