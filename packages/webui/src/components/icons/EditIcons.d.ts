 ...
 */
export declare const PasteIcon: FC<IconProps>;
/**
 * Select all icon (16x16)
 * Used for selecting all content
 */
export declare const SelectAllIcon: FC<IconProps>;
