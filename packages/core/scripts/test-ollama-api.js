 ...
 */
import { createOllamaNativeClient, } from '../src/core/ollamaNativeClient.js';
...
async function main() {
    ...
    if (modelAvailable) {
        ...
        const embeddingModel = models.find((m) => m.name.includes('embed') || m.name.includes('nomic'));
        if (embeddingModel) {
...
//# sourceMappingURL=test-ollama-api.js.map