...
export class LspLanguageDetector {
    ...
    constructor(workspaceContext, fileDiscoveryService) {
     ...
     */
    mapExtensionToLanguage(ext, extensionMap) {
        return extensionMap[ext] || null;
    }
    /**
     * Get extension to language mapping with overrides applied
     */
    getExtensionToLanguageMap(extensionOverrides = {}) {
     ...
     */
    mapMarkerToLanguage(marker) {
        return MARKER_TO_LANGUAGE[marker] || null;
    }
}
//# sourceMappingURL=LspLanguageDetector.js.map