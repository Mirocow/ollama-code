...
export declare class AuthEvent implements BaseTelemetryEvent {
    ...
    status: 'success' | 'error' | 'cancelled';
    error_message?: string;
    constructor(auth_type: string, action_type: 'auto' | 'manual' | 'coding-plan', status: 'success' | 'error' | 'cancelled', error_message?: string);
}
