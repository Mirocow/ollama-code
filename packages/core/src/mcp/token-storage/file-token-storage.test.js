...
describe('FileTokenStorage', () => {
    ...
    describe('setCredentials', () => {
        it('should save credentials with encryption', async () => {
            ...
            expect(mockFs.mkdir).toHaveBeenCalledWith(path.join('/home/test', '.ollama-code'), { recursive: true, mode: 0o700 });
    ...
    describe('deleteCredentials', () => {
        ...
        it('should delete file when last credential is removed', async () => {
            ...
            expect(mockFs.unlink).toHaveBeenCalledWith(path.join('/home/test', '.ollama-code', 'mcp-oauth-tokens-v2.json'));
        });
