    ...
    describe('with encrypted flag false', () => {
        ...
        describe('getAllCredentials', () => {
            ...
            it('should load tokens from file successfully', async () => {
                ...
                expect(fs.readFile).toHaveBeenCalledWith(path.join('/mock/home', OLLAMA_DIR, 'mcp-oauth-tokens.json'), 'utf-8');
            });
        ...
        describe('saveToken', () => {
            it('should save token with restricted permissions', async () => {
                ...
                expect(fs.mkdir).toHaveBeenCalledWith(path.join('/mock/home', OLLAMA_DIR), { recursive: true });
                expect(fs.writeFile).toHaveBeenCalledWith(path.join('/mock/home', OLLAMA_DIR, 'mcp-oauth-tokens.json'), expect.stringContaining('test-server'), { mode: 0o600 });
            });
        ...
        describe('deleteCredentials', () => {
            ...
            it('should remove token file when no tokens remain', async () => {
                ...
                expect(fs.unlink).toHaveBeenCalledWith(path.join('/mock/home', OLLAMA_DIR, 'mcp-oauth-tokens.json'));
