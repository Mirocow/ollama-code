 ...
 */
import type { AuthType, ContentGeneratorConfig } from '../core/contentGenerator.js';
 ...
 */
export type ModelGenerationConfig = Pick<ContentGeneratorConfig, 'samplingParams' | 'timeout' | 'maxRetries' | 'schemaCompliance' | 'reasoning' | 'customHeaders' | 'extra_body' | 'contextWindowSize'>;
/**
