...
import { type ModelProvidersConfig, type AvailableModel, type ModelSwitchMetadata, type RuntimeModelSnapshot } from './types.js';
...
export declare class ModelsConfig {
    ...
    private requireCachedCredentialsOnce;
