...
import { createTmpDir, cleanupTmpDir, } from '@ollama-code/ollama-code-test-utils';
describe('Ignore', () => {
...
describe('loadIgnoreRules', () => {
    ...
    it('should load rules from .ollama-codeignore', async () => {
        tmpDir = await createTmpDir({
            '.ollama-codeignore': '*.log',
        });
        const ignore = loadIgnoreRules({
            projectRoot: tmpDir,
            useGitignore: false,
    ...
    it('should combine rules from .gitignore and .ollama-codeignore', async () => {
        tmpDir = await createTmpDir({
            '.gitignore': '*.log',
            '.ollama-codeignore': '*.txt',
        });
        const ignore = loadIgnoreRules({
            projectRoot: tmpDir,
            useGitignore: true,
