      ...
      if (entry.isFile()) {
        ...
        if (options.fileService) {
          const shouldIgnore =
            ...
            (options.fileFilteringOptions.respectOllamaCodeIgnore &&
              options.fileService.shouldOllamaCodeIgnoreFile(filePath));
          if (shouldIgnore) {
            continue;
          }
        }
      ...
      if (entry.isDirectory()) {
        ...
        if (options.fileService) {
          isIgnored =
            ...
            (options.fileFilteringOptions.respectOllamaCodeIgnore &&
              options.fileService.shouldOllamaCodeIgnoreFile(subFolderPath));
        }
