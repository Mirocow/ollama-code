    ...
    async execute(signal, updateOutput, shellExecutionConfig, setPidCallback) {
        ...
        try {
            ...
            if (result.aborted) {
                ...
                const wasTimeout = !this.params.is_background &&
                    effectiveTimeout &&
            ...
            if (summarizeConfig && summarizeConfig[ShellTool.Name]) {
                const summary = await summarizeToolOutput(llmContent, this.config.getOllamaClient(), signal, summarizeConfig[ShellTool.Name].tokenBudget);
                return {
                    llmContent: summary,
...
export class ShellTool extends BaseDeclarativeTool {
    ...
    validateToolParamValues(params) {
        ...
        if (params.directory) {
            ...
            const isWithinUserSkills = isSubpath(userSkillsDir, resolvedDirectoryPath);
