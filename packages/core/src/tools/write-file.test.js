...
describe('WriteFileTool', () => {
    ...
    beforeEach(() => {
        ...
        mockOllamaClientInstance = new (vi.mocked(OllamaClient))(mockConfig);
        ...
        mockConfigInternal.getOllamaClient.mockReturnValue(mockOllamaClientInstance);
