...
describe('SubagentManager', () => {
    ...
    const validConfig = {
        ...
        level: 'project',
        filePath: '/test/project/.ollama-code/agents/test-agent.md',
    };
    const validMarkdown = `---
name: test-agent
description: A test subagent
...
`;
        ...
        it('should determine level from file path', () => {
            const projectPath = '/test/project/.ollama-code/agents/test-agent.md';
            const userPath = '/home/user/.ollama-code/agents/test-agent.md';
...
`;
        ...
        it('should not warn when filename matches subagent name', () => {
            ...
            const matchingPath = '/test/project/.ollama-code/agents/test-agent.md';
    ...
    describe('loadSubagent', () => {
        it('should load subagent from project level first', async () => {
            ...
            expect(config.name).toBe('test-agent');
            expect(fs.readdir).toHaveBeenCalledWith(path.normalize('/test/project/.ollama-code/agents'));
            expect(fs.readFile).toHaveBeenCalledWith(path.normalize('/test/project/.ollama-code/agents/test-agent.md'), 'utf8');
        });
        it('should fall back to user level if project level fails', async () => {
            ...
            expect(config).toBeDefined();
            expect(config.name).toBe('test-agent');
            expect(fs.readdir).toHaveBeenCalledWith(path.normalize('/home/user/.ollama-code/agents'));
            expect(fs.readFile).toHaveBeenCalledWith(path.normalize('/home/user/.ollama-code/agents/test-agent.md'), 'utf8');
        });
...
You are another assistant.`;
            ...
            expect(config.filePath).toBe(path.normalize('/test/project/.ollama-code/agents/wrong-filename.md'));
...
You are a helpful assistant.`;
            ...
            expect(config.filePath).toBe(path.normalize('/home/user/.ollama-code/agents/user-agent.md'));
...
You are a helpful assistant.`;
            ...
            expect(config.filePath).toBe(path.normalize('/test/project/.ollama-code/agents/misnamed-file.md'));
        });
    });
    ...
    describe('deleteSubagent', () => {
        it('should delete subagent from specified level', async () => {
            ...
            expect(fs.unlink).toHaveBeenCalledWith(path.normalize('/test/project/.ollama-code/agents/test-agent.md'));
        });
        it('should delete from both levels if no level specified', async () => {
            ...
            expect(fs.unlink).toHaveBeenCalledWith(path.normalize('/test/project/.ollama-code/agents/test-agent.md'));
            expect(fs.unlink).toHaveBeenCalledWith(path.normalize('/home/user/.ollama-code/agents/test-agent.md'));
        });
        it('should throw error if subagent not found', async () => {
            vi.mocked(fs.readdir).mockRejectedValue(new Error('Directory not found'));
...
You are a helpful assistant.`;
            ...
            expect(fs.unlink).toHaveBeenCalledWith(path.normalize('/test/project/.ollama-code/agents/wrong-name.md'));
        });
...
Target content`,
            ...
            expect(fs.unlink).toHaveBeenCalledWith(path.normalize('/test/project/.ollama-code/agents/target-file.md'));
        });
    });
