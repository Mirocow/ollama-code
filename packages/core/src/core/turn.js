...
export var OllamaEventType;
(function (OllamaEventType) {
    OllamaEventType["Content"] = "content";
    OllamaEventType["ToolCallRequest"] = "tool_call_request";
    OllamaEventType["ToolCallResponse"] = "tool_call_response";
    OllamaEventType["ToolCallConfirmation"] = "tool_call_confirmation";
    OllamaEventType["UserCancelled"] = "user_cancelled";
    OllamaEventType["Error"] = "error";
    OllamaEventType["ChatCompressed"] = "chat_compressed";
    OllamaEventType["Thought"] = "thought";
    OllamaEventType["MaxSessionTurns"] = "max_session_turns";
    OllamaEventType["SessionTokenLimitExceeded"] = "session_token_limit_exceeded";
    OllamaEventType["Finished"] = "finished";
    OllamaEventType["LoopDetected"] = "loop_detected";
    OllamaEventType["Citation"] = "citation";
    OllamaEventType["Retry"] = "retry";
})(OllamaEventType || (OllamaEventType = {}));
