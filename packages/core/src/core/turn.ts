...
export interface ChatCompressionInfo {
  ...
  /** The summary generated by the model (may be empty if compression failed) */
  summary?: string;
  ...
  async *run(
    ...
    try {
      ...
      for await (const streamEvent of responseStream) {
        ...
        // Always yield 'Finished' event - even without finishReason
        // This ensures assistant responses are always recorded to storage
      ...
      yield {
        ...
        value: {
          ...
          usageMetadata: this.debugResponses.length > 0 
            ? this.debugResponses[this.debugResponses.length - 1].usageMetadata 
            : undefined,
        },
      };
    } catch (e) {
