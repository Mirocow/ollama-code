...
`.trim();
    ...
    const writeSystemMdResolution = resolvePathFromEnv(process.env['OLLAMA_CODE_WRITE_SYSTEM_MD']);
...
function getToolCallExamples(model) {
    ...
    if (toolCallStyle) {
        switch (toolCallStyle.toLowerCase()) {
            ...
            default:
                debugLogger.warn(`Unknown OLLAMA_CODE_TOOL_CALL_STYLE value: ${toolCallStyle}. Using model-based detection.`);
                break;
        }
    }
