...
export declare const EXTENSIONS_CONFIG_FILENAME = "ollama-extension.json";
export declare const INSTALL_METADATA_FILENAME = ".ollama-code-extension-install.json";
