...
import { convertGeminiToOllamaConfig, isGeminiExtensionConfig, } from './gemini-converter.js';
// Mock fs module
...
describe('convertGeminiToOllamaConfig', () => {
    beforeEach(() => {
        vi.clearAllMocks();
    });
    afterEach(() => {
    ...
    it('should convert basic Gemini config from directory', () => {
        ...
        const result = convertGeminiToOllamaConfig(mockDir);
    ...
    it('should throw error for missing name', () => {
        ...
        expect(() => convertGeminiToOllamaConfig(mockDir)).toThrow('Gemini extension config must have name and version fields');
    });
