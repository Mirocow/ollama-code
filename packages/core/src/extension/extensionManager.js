...
import { EXTENSIONS_CONFIG_FILENAME, INSTALL_METADATA_FILENAME, recursivelyHydrateStrings, } from './variables.js';
...
export class ExtensionManager {
    ...
    async checkForAllExtensionUpdates(callback) {
        ...
        for (const extension of extensions) {
            ...
            promises.push(checkForExtensionUpdate(extension, this).then((state) => callback(extension.name, state)));
        }
