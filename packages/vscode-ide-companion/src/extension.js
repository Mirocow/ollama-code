...
import { detectIdeFromEnv, IDE_DEFINITIONS, } from '@ollama-code/ollama-code-core/src/ide/detect-ide.js';
import { WebViewProvider } from './webview/WebViewProvider.js';
import { registerNewCommands } from './commands/index.js';
import { ReadonlyFileSystemProvider } from './services/readonlyFileSystemProvider.js';
import { isWindows } from './utils/platform.js';
const CLI_IDE_COMPANION_IDENTIFIER = 'qwenlm.ollama-code-vscode-ide-companion';
...
let ideServer;
let logger;
let webViewProviders = []; // Track multiple chat tabs
let log = () => { };
...
export async function activate(context) {
    ...
    () => {
        const providers = webViewProviders.filter((p) => typeof p.shouldSuppressDiff === 'function');
    ...
    registerNewCommands(context, log, diffManager, () => webViewProviders, createWebViewProvider);
    ...
    context.subscriptions.push(vscode.workspace.onDidChangeWorkspaceFolders(() => {
        ...
        ideServer.syncEnvVars();
    }), vscode.commands.registerCommand('ollama-code.run', async (location) => {
    ...
    }), vscode.commands.registerCommand('ollama-code.showNotices', async () => {
