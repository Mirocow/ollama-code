 ...
 */
export const useWebViewMessages = ({ sessionManagement, fileContext, messageHandling, handleToolCallUpdate, clearToolCalls, setPlanEntries, handlePermissionRequest, inputFieldRef, setInputText, setEditMode, setIsAuthenticated, setUsageStats, setModelInfo, setAvailableCommands, setAvailableModels, }) => {
    ...
    const handleMessage = useCallback((event) => {
        ...
        switch (message.type) {
            ...
            case 'message': {
                ...
                handlers.messageHandling.addMessage(msg);
            ...
            case 'streamStart':
                handlers.messageHandling.startStreaming(message.data?.timestamp);
                break;
            case 'streamChunk': {
            ...
            case 'streamEnd': {
                ...
                try {
                    const reason = (message.data?.reason || '').toLowerCase();
                    /**
