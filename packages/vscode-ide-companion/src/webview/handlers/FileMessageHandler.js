...
import { findLeftGroupOfChatWebview, ensureLeftGroupOfChatWebview, } from '../../utils/editorGroupUtils.js';
import { ReadonlyFileSystemProvider } from '../../services/readonlyFileSystemProvider.js';
import { FileDiscoveryService } from '@ollama-code/ollama-code-core/src/services/fileDiscoveryService.js';
/**
...
export class FileMessageHandler extends BaseMessageHandler {
    ...
    async handleGetWorkspaceFiles(query, requestId) {
        try {
            ...
            if (query) {
                ...
                console.log('[FileMessageHandler] Searching workspace files for query', query);
                const uris = await vscode.workspace.findFiles(includePattern, '**/{.git,node_modules}/**', 50);
    ...
    async handleCreateAndOpenTempFile(data) {
        ...
        try {
            ...
            vscode.window.showErrorMessage(`Failed to create and open temporary file: ${error}`);
        }
    }
