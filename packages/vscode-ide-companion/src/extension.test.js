...
import { IDE_DEFINITIONS, detectIdeFromEnv, } from '@ollama-code/ollama-code-core/src/ide/detect-ide.js';
vi.mock('@ollama-code/ollama-code-core/src/ide/detect-ide.js', async () => {
    const actual = await vi.importActual('@ollama-code/ollama-code-core/src/ide/detect-ide.js');
    return {
        ...actual,
...
describe('activate', () => {
    ...
    describe('update notification', () => {
        ...
        it('should execute the install command when the user clicks "Update"', async () => {
            ...
            expect(executeCommandMock).toHaveBeenCalledWith('workbench.extensions.installExtension', 'qwenlm.ollama-code-vscode-ide-companion');
        });
