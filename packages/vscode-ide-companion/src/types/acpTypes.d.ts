...
export declare const authMethod = "qwen-oauth";
...
export interface ToolCallUpdate extends BaseSessionUpdate {
    update: {
        ...
        title: string;
        kind: 'read' | 'edit' | 'execute' | 'delete' | 'move' | 'search' | 'fetch' | 'think' | 'other';
        rawInput?: unknown;
        content?: Array<{
            type: 'content' | 'diff';
            content?: {
...
export type AcpSessionUpdate = UserMessageChunkUpdate | AgentMessageChunkUpdate | AgentThoughtChunkUpdate | ToolCallUpdate | ToolCallStatusUpdate | PlanUpdate | CurrentModeUpdate | CurrentModelUpdate | AvailableCommandsUpdate;
