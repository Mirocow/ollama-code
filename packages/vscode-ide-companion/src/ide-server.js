...
import { CloseDiffRequestSchema, IdeContextNotificationSchema, OpenDiffRequestSchema, } from '@ollama-code/ollama-code-core/src/ide/types.js';
import { detectIdeFromEnv } from '@ollama-code/ollama-code-core/src/ide/detect-ide.js';
...
const IDE_SERVER_PORT_ENV_VAR = 'OLLAMA_CODE_IDE_SERVER_PORT';
const IDE_WORKSPACE_PATH_ENV_VAR = 'OLLAMA_CODE_IDE_WORKSPACE_PATH';
...
async function getGlobalIdeDir() {
    ...
    const baseDir = homeDir
        ? path.join(homeDir, OLLAMA_DIR)
        : path.join(os.tmpdir(), OLLAMA_DIR);
...
const createMcpServer = (diffManager) => {
    const server = new McpServer({
        name: 'ollama-code-companion-mcp-server',
        version: '1.0.0',
