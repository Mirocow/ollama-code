...
export class OllamaSessionUpdateHandler {
    ...
    handleSessionUpdate(data) {
        ...
        console.log('[SessionUpdateHandler] Processing update type:', update.sessionUpdate);
        switch (update.sessionUpdate) {
            ...
            case 'current_model_update': {
                ...
                try {
                    ...
                    console.warn('[SessionUpdateHandler] Failed to handle model update', err);
                }
                break;
            }
...
//# sourceMappingURL=ollamaSessionUpdateHandler.js.map