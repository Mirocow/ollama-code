...
export class OllamaSessionManager {
     ...
     */
    async saveSession(messages, sessionName, workingDir) {
        try {
    ...
    async loadSession(sessionId, workingDir) {
        try {
            ...
            if (!fs.existsSync(filePath)) {
                console.log(`[OllamaSessionManager] Session file not found: ${filePath}`);
                return null;
            }
        ...
        try {
            ...
            for (const file of files) {
                try {
                    ...
                    console.error(`[OllamaSessionManager] Failed to read session file ${file}:`, error);
                }
            }
...
//# sourceMappingURL=ollamaSessionManager.js.map