...
Headless mode allows you to run Ollama Code programmatically from command line
scripts and automation tools without any interactive UI. This is ideal for
scripting, automation, CI/CD pipelines, and building AI-powered tools.

## Overview

The headless mode provides a headless interface to Ollama Code that:
...
Pipe input to Ollama Code from your terminal:
...
Read from files and process with Ollama Code:
...
> [!note]
>
> - Session data is project-scoped JSONL under `~/.ollama-code/projects/<sanitized-cwd>/chats`.
> - Restores conversation history, tool outputs, and chat-compression checkpoints before sending the new prompt.

## Output Formats

Ollama Code supports multiple output formats for different use cases:
...
The `--input-format` parameter controls how Ollama Code consumes input from standard input:
