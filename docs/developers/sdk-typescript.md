...
- Node.js >= 20.0.0
- [Ollama Code](https://github.com/QwenLM/ollama-code) >= 0.4.0 (stable) installed and accessible in PATH

> **Note for nvm users**: If you use nvm to manage Node.js versions, the SDK may not be able to auto-detect the Ollama Code executable. You should explicitly set the `pathToQwenExecutable` option to the full path of the `qwen` binary.
...
| `model`                  | `string`                                       | -                | The AI model to use (e.g., `'qwen-max'`, `'qwen-plus'`, `'qwen-turbo'`). Takes precedence over `OPENAI_MODEL` and `OLLAMA_MODEL` environment variables.                                                                                                                                                                                                                                                                                                                                     |
