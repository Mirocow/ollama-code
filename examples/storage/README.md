...
Все примеры запускаются с флагом `--file`:
...
**Важно:** Примеры содержат инструкции для AI модели. Модель прочитает файл и выполнит указанные действия с помощью инструментов `model_storage`.
