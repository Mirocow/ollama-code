...
```json
{
  ...
  "yolo": true,
  "source_repo": ".",
  "worktree_base": "~/.ollama-code/worktrees",
  "outputs_dir": "./outputs",
...
| `worktree_base` | string | ~/.ollama-code/worktrees | Base directory for git worktrees              |
  ...
  "runs": [
    {
      ...
      "status": "succeeded",
      "worktree_path": "~/.ollama-code/worktrees/run-abc123",
