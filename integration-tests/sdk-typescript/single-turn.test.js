...
import { query, isSDKAssistantMessage, isSDKSystemMessage, isSDKResultMessage, isSDKPartialAssistantMessage, } from '@ollama-code/sdk';
    ...
    describe('System Initialization', () => {
        it('should receive system message with initialization info', async () => {
            ...
            try {
                ...
                expect(systemMessage.ollama - code_code_version).toBeDefined();
