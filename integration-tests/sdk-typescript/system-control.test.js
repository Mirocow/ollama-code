...
import { query, isSDKAssistantMessage, isSDKSystemMessage, isSDKResultMessage, } from '@ollama-code/sdk';
...
describe('System Control (E2E)', () => {
    ...
    describe('setModel API', () => {
        it('should change model dynamically during streaming input', async () => {
            ...
            const { generator, resume } = createStreamingInputWithControlPoint('Tell me the model name.', 'Tell me the model name now again.', resultWaiter);
            const q = query({
                prompt: generator,
                options: {
                    ...SHARED_TEST_OPTIONS,
