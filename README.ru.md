...
<p align="center">
  <img src="./assets/interface-full.png" alt="Интерфейс Ollama Code" width="100%">
</p>

### Основные элементы интерфейса

<p align="center">
  <img src="./assets/interface-header.png" alt="Заголовок с полосой контекста" width="70%">
</p>

| Элемент | Описание |
|---------|----------|
| **Логотип** | Анимированный градиентный логотип OLLAMA |
| **Информация о модели** | Тип подключения, URL сервера, имя модели с бейджами возможностей (🔧 инструменты, 🧠 thinking, 📷 vision, 📋 структурированный вывод) |
| **Полоса контекста** | Размер контекстного окна (например, 131K), размер модели (например, 14B), визуальный прогресс-бар использования |
| **ID сессии** | Уникальный идентификатор сессии для отладки |
| **Рабочая директория** | Текущий путь к проекту |

### Прогресс-бар использования контекста

<p align="center">
  <img src="./assets/interface-demo.png" alt="Прогресс-бар контекста" width="60%">
</p>

Прогресс-бар показывает использование контекстного окна в реальном времени:

- **Зелёный/Синий**: Нормальное использование (< 75%)
- **Жёлтый**: Приближение к лимиту (> 90%)
- Полоса заполняется по мере использования контекстного окна
