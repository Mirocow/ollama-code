...
|---------------|-----------|-------------------|------------|
| 3B | 4 ГБ | RTX 3050, GTX 1660 | Базовые модели, рекомендуется квантизация |
| 7B | 6 ГБ | RTX 3060, RTX 4060 | Хорошее соотношение скорости и качества |
| 8B | 8 ГБ | RTX 3070, RTX 4060 Ti | DeepSeek R1, Llama 3.1 |
| 14B | 12 ГБ | RTX 3080, RTX 4070 | Qwen2.5-Coder 14B |
| 30B | 20 ГБ | RTX 3090, RTX 4090 | Qwen3-Coder 30B |
| 70B+ | 40+ ГБ | 2x RTX 3090, A100 | Требует несколько GPU или облако |
...
| RTX 4090 | 24 ГБ | qwen3-coder:30b | Q8_0 | 35-45 | Превосходно |
| RTX 4090 | 24 ГБ | deepseek-r1:32b | Q5_K_M | 28-35 | Превосходно |

> **Примечание**: Скорость зависит от длины контекста, сложности промпта и конфигурации системы. Оценка качества субъективна и основана на точности генерации кода и связности.
