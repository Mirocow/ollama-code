...
const warningsFilePath = path.join(os.tmpdir(), 'ollama-code-warnings.txt'); // Temp file for warnings
// ---------------------
...
function findSourceFiles(dir, allFiles = []) {
  ...
  for (const entry of entries) {
    ...
    // Skip node_modules, build dir, and generated files (auto-generated on each build)
    if (
      entry.isDirectory() &&
